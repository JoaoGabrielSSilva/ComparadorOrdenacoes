...
from quickSort import OrdenaRapidoPrincipal  # Importa uma função "OrdenaRapidoPrincipal" do outro arquivo (quickSort.py)
from mergeSort import OrdenaMescla  # Importa uma função "OrdenaMescla" do outro arquivo (mergeSort.py)
from bogoSort import bogoSort  # Importa uma função "bogoSort" do outro arquivo (bogoSort.py)
...
root.maxsize(900, 600)  # Define o tamanho máximo da janela
...
def desenharDados(dados, listaCores):
    ...
    for i, altura in enumerate(dadosNormalizados):
        ...
        y1 = alturaCanvas
        # Cria um retângulo no canvas para representar cada elemento da lista
        canvas.create_rectangle(x0, y0, x1, y1, fill=listaCores[i])
        # Adiciona o valor de cada elemento como texto no retângulo
